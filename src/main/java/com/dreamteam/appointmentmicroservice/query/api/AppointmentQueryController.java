...
public class AppointmentQueryController {
    ...
    @ApiOperation(value = "Obtener un listado de citas mediante su estado", response = List.class)
    public ResponseEntity<List<AppointmentView>> getAllByAppointmentStatus(@PathVariable("status")String status) {
        try {
